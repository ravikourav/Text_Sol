    ...
    <div className='container' style={darkMode}>
        ...
        <div className="accordion" id="accordionExample">
            <div className="accordion-item">
                ...
                <div style={darkMode} className="accordion-body">
            ...
            <div className="accordion-item">
                ...
                <div style={darkMode} id="collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
        ...
        <button onClick={toggelMode} type="button" className='btn btn-primary my-2'>{btnText}</button>
    </div>
  )
}
